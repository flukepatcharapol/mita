...
ARG _ACCESS_TOKEN_1
ARG _ACCESS_TOKEN_2
RUN robot -v POS_USER:$_POS_USER -v POS_PASS:$_POS_PASS -v LINE_FLUKE_UID:$_FLUKE_UID -v LINE_ACCESS_TOKEN_1:$_ACCESS_TOKEN_1 LINE_ACCESS_TOKEN_2:$_ACCESS_TOKEN_2 -i test-connect Script.robot
