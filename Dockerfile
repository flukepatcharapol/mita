...
ARG _PROJECT_ID
ARG _SCRIPT_TAG
RUN robot -v POS_USER:$_POS_USER -v POS_PASS:$_POS_PASS -v FLUKE_UID:$_FLUKE_UID -v ACCESS_TOKEN:$_ACCESS_TOKEN -v PROJECT_ID:$_PROJECT_ID -i $_SCRIPT_TAG Script.robot