...
#Run robot command
RUN robot -v POS_USER:$_POS_USER -v POS_PASS:$_POS_PASS -v LINE_FLUKE_UID:$_FLUKE_UID -v LINE_ACCESS_TOKEN:$_ACCESS_TOKEN -v IS_LOCAL:$_IS_LOCAL -i $_SCRIPT_TAG Script.robot